...
public class CourseViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_course_viewer);
    ...
    private void setStatusLabel() {
        tvStatus = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvStatus);
        String status = "";
    ...
    private void findElements() {
        tvCourseName = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvCourseName);
        tvCourseName.setText(course.name);
        tvStartDate = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvCourseStart);
        tvStartDate.setText(course.start);
        tvEndDate = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvCourseEnd);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(wgu.gkmC196.course_scheduler.R.menu.menu_course_viewer, menu);
        this.menu = menu;
    ...
    private void showAppropriateMenuOptions() {
        ...
        menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_enable_notifications).setVisible(true);
        menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_disable_notifications).setVisible(true);

        if (course.notifications == 1) {
            menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_enable_notifications).setVisible(false);
        }
        else {
            menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_disable_notifications).setVisible(false);
        }
        ...
        switch (course.status.toString()) {
            case "PLANNED":
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_drop_course).setVisible(false);
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_start_course).setVisible(true);
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_mark_course_completed).setVisible(false);
                break;
            case "IN_PROGRESS":
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_drop_course).setVisible(true);
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_start_course).setVisible(false);
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_mark_course_completed).setVisible(true);
                break;
            case "COMPLETED":
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_drop_course).setVisible(false);
                menu.findItem(wgu.gkmC196.course_scheduler.R.id.action_start_course).setVisible(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case wgu.gkmC196.course_scheduler.R.id.action_edit_course:
                return editCourse();
            case wgu.gkmC196.course_scheduler.R.id.action_delete_course:
                return deleteCourse();
            case wgu.gkmC196.course_scheduler.R.id.action_enable_notifications:
                return enableNotifications();
            case wgu.gkmC196.course_scheduler.R.id.action_disable_notifications:
                return disableNotifications();
            case wgu.gkmC196.course_scheduler.R.id.action_drop_course:
                return dropCourse();
            case wgu.gkmC196.course_scheduler.R.id.action_start_course:
                return startCourse();
            case wgu.gkmC196.course_scheduler.R.id.action_mark_course_completed:
        ...
        DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                if (button == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    setResult(RESULT_OK);
                    finish();
                    Toast.makeText(CourseViewerActivity.this, getString(wgu.gkmC196.course_scheduler.R.string.course_deleted), Toast.LENGTH_SHORT).show();
                }
            }
        };

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(wgu.gkmC196.course_scheduler.R.string.confirm_delete_course)
