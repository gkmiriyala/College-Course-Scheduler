...
public class AssessmentNoteEditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_note_editor);
        Toolbar toolbar = (Toolbar) findViewById(wgu.gkmC196.course_scheduler.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        assessmentNoteTextField = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etAssessmentNoteText);
        assessmentNoteUri = getIntent().getParcelableExtra(DataProvider.ASSESSMENT_NOTE_CONTENT_TYPE);
        if (assessmentNoteUri == null) {
            setTitle(wgu.gkmC196.course_scheduler.R.string.enter_new_note);
            ...
            setTitle(wgu.gkmC196.course_scheduler.R.string.edit_note);
