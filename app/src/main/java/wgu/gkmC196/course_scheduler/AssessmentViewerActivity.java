...
public class AssessmentViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_viewer);
        Toolbar toolbar = (Toolbar) findViewById(wgu.gkmC196.course_scheduler.R.id.toolbar);
        setSupportActionBar(toolbar);
        FloatingActionButton fab = (FloatingActionButton) findViewById(wgu.gkmC196.course_scheduler.R.id.fab);
    ...
    private void loadAssessment() {
        ...
        tvAssessmentTitle = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvAssessmentTitle);
        tvAssessmentDescription = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvAssessmentDescription);
        tvAssessmentDatetime = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvAssessmentDatetime);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(wgu.gkmC196.course_scheduler.R.menu.menu_assessment_viewer, menu);
        this.menu = menu;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case wgu.gkmC196.course_scheduler.R.id.action_delete_assessment:
        ...
        DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                if (button == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    setResult(RESULT_OK);
                    finish();
                    Toast.makeText(AssessmentViewerActivity.this, getString(wgu.gkmC196.course_scheduler.R.string.assessment_deleted), Toast.LENGTH_SHORT).show();
                }
            }
        };
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(wgu.gkmC196.course_scheduler.R.string.confirm_delete_assessment)
