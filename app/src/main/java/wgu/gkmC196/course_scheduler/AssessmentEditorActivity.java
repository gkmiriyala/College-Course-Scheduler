...
public class AssessmentEditorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_editor);
        Toolbar toolbar = (Toolbar) findViewById(wgu.gkmC196.course_scheduler.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        etAssessmentCode = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etAssessmentCode);
        etAssessmentName = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etAssessmentName);
        etAssessmentDescription = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etAssessmentDescription);
        etAssessmentDatetime = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etAssessmentDatetime);

        Uri assessmentUri = getIntent().getParcelableExtra(DataProvider.ASSESSMENT_CONTENT_TYPE);
        if (assessmentUri == null) {
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.new_assessment));
            ...
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.edit_assessment));
