...
public class AssessmentListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_list);
    ...
    protected void bindAssessmentList() {
        ...
        int[] to = {wgu.gkmC196.course_scheduler.R.id.tvAssessmentCode, wgu.gkmC196.course_scheduler.R.id.tvAssessmentName, wgu.gkmC196.course_scheduler.R.id.tvAssessmentDatetime};
        cursorAdapter = new SimpleCursorAdapter(this, wgu.gkmC196.course_scheduler.R.layout.assessment_list_item, null, from, to, 0);
        DataProvider database = new DataProvider();
        ListView list = (ListView) findViewById(wgu.gkmC196.course_scheduler.R.id.assessmentListView);
