...
public class CourseNoteViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_course_note_viewer);
        Toolbar toolbar = (Toolbar) findViewById(wgu.gkmC196.course_scheduler.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        tvCourseNoteText = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvCourseNoteText);
        ...
        if (courseNoteUri != null) {
            ...
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.view_course_note));
            loadNote();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(wgu.gkmC196.course_scheduler.R.menu.menu_course_note_viewer, menu);
        MenuItem item = menu.findItem(wgu.gkmC196.course_scheduler.R.id.menu_item_share);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case wgu.gkmC196.course_scheduler.R.id.action_delete_course_note:
                return deleteCourseNote();
            case wgu.gkmC196.course_scheduler.R.id.action_add_picture:
                return addPicture();
            default:
        ...
        DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                if (button == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    setResult(RESULT_OK);
                    finish();
                    Toast.makeText(CourseNoteViewerActivity.this, getString(wgu.gkmC196.course_scheduler.R.string.note_deleted), Toast.LENGTH_SHORT).show();
                }
            }
        };
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(wgu.gkmC196.course_scheduler.R.string.confirm_delete_note)
