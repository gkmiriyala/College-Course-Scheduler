...
public class AssessmentNoteViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_note_viewer);
        Toolbar toolbar = (Toolbar) findViewById(wgu.gkmC196.course_scheduler.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        tvAssessmentNoteText = (TextView) findViewById(wgu.gkmC196.course_scheduler.R.id.tvAssessmentNoteText);
        ...
        if (assessmentNoteUri != null) {
            ...
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.view_assessment_note));
            loadNote();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(wgu.gkmC196.course_scheduler.R.menu.menu_assessment_note_viewer, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case wgu.gkmC196.course_scheduler.R.id.action_delete_assessment_note:
        ...
        DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                if (button == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    setResult(RESULT_OK);
                    finish();
                    Toast.makeText(AssessmentNoteViewerActivity.this, getString(wgu.gkmC196.course_scheduler.R.string.note_deleted), Toast.LENGTH_SHORT).show();
                }
            }
        };
