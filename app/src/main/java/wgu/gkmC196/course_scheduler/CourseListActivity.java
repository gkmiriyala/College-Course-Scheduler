...
public class CourseListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_course_list);
    ...
    private void loadTermData() {
        if (termUri == null) {
            ...
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.courses));
        }
    }
    ...
    private void bindClassList() {
        ...
        int[] to = {wgu.gkmC196.course_scheduler.R.id.tvCourseName, wgu.gkmC196.course_scheduler.R.id.tvCourseStartDate, wgu.gkmC196.course_scheduler.R.id.tvCourseEndDate, wgu.gkmC196.course_scheduler.R.id.tvCourseStatus};

        cursorAdapter = new MySimpleCursorAdapter(this, wgu.gkmC196.course_scheduler.R.layout.course_list_item, null, from, to);
    ...
    public class MySimpleCursorAdapter extends android.support.v4.widget.SimpleCursorAdapter {
        ...
        public void setViewText(TextView view, String text) {
            if (view.getId() == wgu.gkmC196.course_scheduler.R.id.tvCourseStatus) {
                String status = "";
                switch (text) {
                    case "PLANNED":
                        status = "Plan to Take";
