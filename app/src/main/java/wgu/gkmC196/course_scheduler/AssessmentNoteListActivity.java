...
public class AssessmentNoteListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_assessment_note_list);
    ...
    private void bindAssessmentNoteList() {
        ...
        int[] to = {wgu.gkmC196.course_scheduler.R.id.tvAssessmentNoteText};
        cursorAdapter = new SimpleCursorAdapter(this, wgu.gkmC196.course_scheduler.R.layout.assessment_note_list_item, null, from, to, 0);
        DataProvider database = new DataProvider();
        ListView list = (ListView) findViewById(wgu.gkmC196.course_scheduler.R.id.assessmentNoteListView);
