...
public class CourseNoteListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_course_note_list);
    ...
    private void bindCourseNoteList() {
        ...
        int[] to = {wgu.gkmC196.course_scheduler.R.id.tvCourseNoteText};
        cursorAdapter = new SimpleCursorAdapter(this, wgu.gkmC196.course_scheduler.R.layout.course_note_list_item, null, from, to, 0);
        DataProvider database = new DataProvider();

        ListView list = (ListView) findViewById(wgu.gkmC196.course_scheduler.R.id.courseNoteListView);
