...
public class CourseEditorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_course_editor);
        ...
        if (courseUri == null) {
            ...
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.add_new_course));
        }
        else {
            action = Intent.ACTION_EDIT;
            setTitle(getString(wgu.gkmC196.course_scheduler.R.string.edit_course_title));
    ...
    private void findViews() {
        etCourseName = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseName);
        etCourseStart = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseStart);
        etCourseEnd = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseEnd);
        etCourseMentor = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseMentor);
        etCourseMentorPhone = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseMentorPhone);
        etCourseMentorEmail = (EditText) findViewById(wgu.gkmC196.course_scheduler.R.id.etCourseMentorEmail);
    }
