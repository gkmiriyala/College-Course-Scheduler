...
public class ImageListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(wgu.gkmC196.course_scheduler.R.layout.activity_image_list);
    ...
    private void bindImagesList() {
        ...
        int[] to = {wgu.gkmC196.course_scheduler.R.id.imageView, wgu.gkmC196.course_scheduler.R.id.imageText};
        cursorAdapter = new MySimpleCursorAdapter(this, wgu.gkmC196.course_scheduler.R.layout.image_list_item, null, from, to);
        DataProvider database = new DataProvider();
        ListView list = (ListView) findViewById(wgu.gkmC196.course_scheduler.R.id.lvImages);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setDataAndType(FileProvider.getUriForFile(ImageListActivity.this, ImageListActivity.this
                        .getApplicationContext().getPackageName() + ".wgu.gkmC196.course_scheduler.provider", file), "image/*");
                Toast.makeText(ImageListActivity.this, FileProvider.getUriForFile(ImageListActivity.this, ImageListActivity.this.getApplicationContext().getPackageName() + ".wgu.gkmC196.course_scheduler.provider", file).toString(), Toast.LENGTH_LONG).show();
